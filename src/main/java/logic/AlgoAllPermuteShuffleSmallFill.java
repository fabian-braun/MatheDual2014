...
public class AlgoAllPermuteShuffleSmallFill extends AbstractAlgo implements
		Runnable {
	private static Logger log = LoggerFactory
			.getLogger(AlgoAllPermuteShuffleSmallFill.class);
	...
	public AlgoAllPermuteShuffleSmallFill(Task t) {
		this.task = t;
		maxFlank = 0;
		int surfaceArea = 0;
		for (byte i = 1; i < 10; i++) {
